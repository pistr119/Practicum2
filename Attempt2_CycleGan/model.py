...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 15:39:15 2019

@author: datadude
"""

#code borrowed from https://github.com/ckmarkoh/GAN-tensorflow
...
from layers import general_conv2d
from layers import general_deconv2d
...
def build_generator_resnet_6blocks(inputgen, name="generator"):
    with tf.variable_scope(name):
        f=7
        ks=3
        pad_input=tf.pad(inputgen, [[0,0], [ks,ks], [0,0]], "REFLECT")
        o_c1=general_conv2d(pad_input, ngf, f,f, 1,1,.02, name="c1")
        o_c2=general_conv2d(o_c1, ngf*2, ks, ks, 2,2,.02, "SAME", "c2")
        o_c3=general_conv2d(o_c2, ngf*4, ks, ks, 2,2,.02, "SAME", "c3")
